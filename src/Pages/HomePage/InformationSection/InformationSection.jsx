    ...
    return (
        <div className="max-w-7xl mx-auto my-20">
            <div className="grid lg:grid-cols-3 gap-5 lg:gap-0 mx-2">
                {/* opening hour */}
                <div className="flex gap-5 bg-[#07332F] text-white h-[180px]  justify-center rounded-lg lg:mx-3">
                    {/* react-icon */}
                ...
                {/* Location */}
                <div className="flex gap-5 bg-[#F7A582] text-white h-[180px]  justify-center rounded-lg lg:mx-3">
                    {/* react-icon */}
                    <div className="text-5xl mt-8">
                        <IoLocationOutline />
                    </div>
